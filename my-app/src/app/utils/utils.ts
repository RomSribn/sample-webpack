...
export function showLoginBtn(rootParent: HTMLElement) {
  const content =  `
      <div class="authorization-box">
        <button class="activeButton" id="login-btn">Login</button>
      </div>
      `;
  rootParent.innerHTML = content;
  loginBtnClickEvent();
}

export function getLevelHTML(fieldListName: string, title: string, dataListConfig: {controllerName: string, containerId: string, inputId: string, listId: string, currentValue: string}): string {
